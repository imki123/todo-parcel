...
console.log("hello world"); //states in app
...
var increase2 = document.querySelector("#increase2");
var decrease2 = document.querySelector("#decrease2"); //toggle
...
function doInterval(num) {
  ...
  state.interval = setInterval(function () {
    ...
    number.value = state.number;
    console.log(time);
  }, time); //faster interval *2 each 1.5s
...
Person.prototype.hello = function () {
  alert("hello, ".concat(this.name));
};

var man = new Person();
var personDiv = document.querySelector('#person div');
var helloButton = document.querySelector('#helloButton');
var helloInput = document.querySelector('#helloInput');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1850" + '/');
